		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mdmasterdetailes5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mdmasterdetailes5-display": {
								"semanticObject": "mdmasterdetailes5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=md.masterdetailes5",
									"url": sap.ui.require.toUrl("md/masterdetailes5")
								}
							}
						}
					}
